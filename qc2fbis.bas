...
120 REM *** BATCH VERSION 2. READS FROM ASCII TEXT FILE
...
190 LET PN$ = "C2FBIS.BAS"
195 REM READ INPUT FROM FILE cinput.txt
200 OPEN "I",1,"cinputbis.csv"
210 REM APPEND LOG OUTPUT TO FILE F2C2F.LOG
220 OPEN "A",2,"F2C2F.log"
240 PRINT#2, "******************************************"
260 PRINT#2, "*** PROGRAM C2FBIS.BAS CONVERTS TEMPERATURE"
280 PRINT#2, "*** FROM CELSIUS TO FAHRENHEIT  DEGREES"
...
400 PRINT#2, DATE$;"|";TIME$;"|";PN$;"|";"READING TEMPERATURES IN CELSIUS DEGREES"
420 INPUT#1, C
425 IF C = -999 THEN 620
430 IF C < -273.15 THEN PRINT#2, DATE$;"|";TIME$;"|";PN$;"|";"READ ";C;": ILLEGAL INPUT":GOTO 420
440 PRINT#2, DATE$;"|";TIME$;"|";PN$;"|";"READ C = ";C
460 LET F = C*9/5 + 32
470 PRINT USING "####.##";F
480 PRINT#2, DATE$;"|";TIME$;"|";PN$;"|";C;" CELSIUS DEGREES = ";INT(F+.5);" FAHRENHEIT DEGREES"
485 GOTO 420
660 CLOSE 1,2
